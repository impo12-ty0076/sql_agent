...
# 내부 모듈 임포트
from .api import auth, database, query, result, admin, python_execution, report_api, query_history, shared_query
...
app.include_router(query_history.router, tags=["쿼리 이력"])
app.include_router(shared_query.router, tags=["쿼리 공유"])
