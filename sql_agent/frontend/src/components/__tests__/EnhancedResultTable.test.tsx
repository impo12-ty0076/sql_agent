...
const mockRows = [
  [1, 'John Doe', 'john@example.com', 30, 'This is a very long description that should be truncated in the table view because it exceeds the character limit for display in a single cell.'],
...
describe('EnhancedResultTable Component', () => {
  ...
  test('handles pagination correctly', () => {
    ...
    const manyRows = Array(25).fill(null).map((_, i) => [
      i + 1,
      `User ${i + 1}`,
