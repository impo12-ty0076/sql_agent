...
describe('StatisticsCard', () => {
  ...
  test('renders with icon', () => {
    render(
      <StatisticsCard title="Test Title" value="123" icon={<InfoIcon data-testid="test-icon" />} />
    );
  ...
  test('renders with description tooltip', () => {
    render(<StatisticsCard title="Test Title" value="123" description="Test Description" />);
