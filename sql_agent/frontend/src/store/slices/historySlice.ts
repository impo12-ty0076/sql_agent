...
const historySlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchQueryHistory.fulfilled, (state, action: PayloadAction<QueryHistoryListResponse>) => {
      state.loading = false;
    ...
    // Update history item
    builder.addCase(updateHistoryItem.fulfilled, (state, action: PayloadAction<QueryHistoryItem>) => {
    ...
    // Create share link
    builder.addCase(createShareLink.fulfilled, (state, action: PayloadAction<ShareLinkResponse>) => {
      // This would be updated when we fetch the share links again
    });
    
    // Update share link
    builder.addCase(updateShareLink.fulfilled, (state, action: PayloadAction<ShareLinkResponse>) => {
      // This would be updated when we fetch the share links again
    });
